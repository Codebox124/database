...
export default function MoviePage({ params }) {
  ...
  const rating = movie.rating || (Math.random() * 2 + 3).toFixed(1);
  
  // Generate a placeholder runtime if not available
  const runtime = movie.runtime || `${Math.floor(Math.random() * 60) + 90} min`;
